		...
		html = html + '<div class="ibox">';
			html = html + '<div class="ibox-content product-box">';
				...
				html = html + '<div class="product-desc">';
					...
					html = html + '<textarea name="slide[content][]" class="form-textarea input-reset image-content" placeholder="Nội dung ảnh" style="width:100%;padding: 5px 10px;height: 80px;"></textarea>';
...
function slide_update(object, id){
	...
	html = html + '<div class="row">';
		...
		html = html + '<div class="col-lg-6">';
			...
			html = html + '<div class="form-row">';
				html = html + '<div class="form-group">';
					html = html + '<label>Nội dung</label> ';
					html = html + '<textarea name="content" class="form-textarea input-reset image-content" placeholder="Nội dung ảnh" style="width:100%;padding: 5px 10px;height: 80px;">'+object.content+'</textarea>';
				html = html + '</div>';
				html = html + '<div class="form-group">';
