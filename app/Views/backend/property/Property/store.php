						...
						<div class="row mb15">
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('title', validate_input(set_value('title', (isset($property['title'])) ? $property['title'] : '')), 'class="form-control title" placeholder="" id="title" autocomplete="off"'); ?>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form-row">
									...
									<?php echo form_input('value', validate_input(set_value('value', (isset($property['value'])) ? $property['value'] : '')), 'class="form-control value" placeholder="" id="value" autocomplete="off"'); ?>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="ibox-content">
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									<label class="control-label text-left">
										<span>Nhóm Thuộc tính <b class="text-danger">(*)</b></span>
									</label>
									<?php
									...
									?>
									<?php echo form_dropdown('parentid', $propertyCatalogue, set_value('parentid', (isset($property['parentid'])) ? $property['parentid'] : ''), 'class="form-control m-b parentid"');?>
								</div>
