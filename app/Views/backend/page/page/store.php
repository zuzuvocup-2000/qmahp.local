							...
							<?php foreach ($page['sub_title'] as $key => $value) {?>
						        ...
						        <div class="ibox desc-more" style="opacity: 1;">
						            ...
						            <div class="ibox-content" style="">
						            	<div class="row">
							                <div class="col-lg-12" >
							                	<textarea name="sub_content[description][]" class="form-control ck-editor" id="<?php echo $id ?>" placeholder="Mô tả"><?php echo $page['sub_content'][$key] ?></textarea>
											</div>
										</div>
						            </div>
						        </div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', (isset($page['image'])) ? $page['image'] : ''))), 'class="form-control " placeholder="Đường dẫn của ảnh"  id="imageTxt"  autocomplete="off" style="display:none;" ');?>
								</div>
							</div>
						</div>
					</div>
