						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_textarea('content', htmlspecialchars_decode(html_entity_decode(set_value('content', (isset($file['content'])) ? $file['content'] : ''))), 'class="form-control ck-editor" id="content" placeholder="" autocomplete="off"');?>
					...
					<div class="ibox-content">
						<?php
							if(isset($_POST['album'])){
								...
								$album = json_decode($file['album'], TRUE);
							}
