<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Chỉnh sửa từ khóa đa ngữ</h2>
		<ol class="breadcrumb">
			<li>
				<a href="<?php echo site_url('admin'); ?>">Trang chủ</a>
			</li>
			<li class="active"><strong>Chỉnh sửa từ khóa đa ngữ</strong></li>
		</ol>
	</div>
</div>
                    ...
                    <div class="ibox-content">
                        <div class="form-group">
                            ...
                            <input type="text" id="keyword" name="keyword" class="form-control" 
                                    ...
                                    placeholder="Ví dụ: sidebar_sb_article" required readonly>
                        ...
                        <div class="d-flex" style="margin-top: 20px;">
                            <div class="form-group text-right">
                                <button type="submit" class="btn btn-primary btn-lg">
                                    <i class="fa fa-save"></i> Cập nhật từ khóa
                                </button>
