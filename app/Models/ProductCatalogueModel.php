...
/**
 * ProductCatalogueModel - Manages product categories and classifications
 * 
 * This model handles product catalogues including hierarchical structures,
 * SEO optimization, and relationship management with products.
 * 
 * @package App\Models
 * @author System
 */
class ProductCatalogueModel extends Model
{
    ...
    protected $validationRules = [
        ...
        'canonical' => 'required|min_length[3]|max_length[255]|is_unique[product_catalogue.canonical,id,{id}]',
